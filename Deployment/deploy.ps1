# Azure Maps Asset Tracking (version 1.0)
# Copyright (c) Microsoft Corporation. All rights reserved.
# https://github.com/Azure-Samples/Azure-Maps-Asset-Tracking
#
...
param(
    ...
    [string]$Name = "assettracker",
    [string]$DatabaseName = "assettracker"
)
...
Options:
    -Location       Azure region where resources will be created. Default is 'uksouth'.
    -Name           Base name for the resources. Default is 'assettracker'.
    -DatabaseName   Name for the Cosmos DB database. Default is 'assettracker'.
...
try {
    ...
    Write-Output "Done! Your Azure Maps Asset Tracking infrastructure and website are ready."
}
catch {
